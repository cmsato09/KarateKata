            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, stance_id: v })
                  }
                >
                  <SelectTrigger>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, technique_id: v })
                  }
                >
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, timing: v })
                  }
                >
                  <SelectTrigger>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, direction: v })
                  }
                >
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, lead_foot: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, active_side: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, speed: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, snap_thrust: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, level: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, breath: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFormState({ ...formState, interm_move: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
